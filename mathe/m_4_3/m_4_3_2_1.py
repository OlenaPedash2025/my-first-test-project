...
def calculate_stats():
    ...
    varianz = statistics.variance(data)  # Stichprobenvarianz
    std_abw = statistics.stdev(data)     # Standardabweichung

    print("\n" + "="*30)
    print(f"Daten (sortiert):   {format_num(data)}")
    print("-" * 30)
